@echo off
REM Megaton Hammer: configure 2Ship with MSVC + CMake/Ninja (mirrors SoH).
REM apply-mh-patches.cmd installs this INTO the 2Ship working tree, so %~dp0 is the fork dir.
